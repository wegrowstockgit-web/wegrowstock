...
export function LoginPage() {
  ...
  const [tenantSlug, setTenantSlug] = useState('demo-corp');
  ...
  const loginMutation = useMutation({
    ...
    onError: (err: AxiosError<{ title?: string; detail?: string; ssoAuthorizationUrl?: string }>) => {
      ...
      setError('Invalid company, email, or password. Try demo-corp / owner@demo.test / password123');
    },
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    loginMutation.mutate({ tenantSlug, email, password });
  ...
  return (
    ...
    <div className="flex min-h-screen">
      ...
      {/* Brand panel — sky blue from reference design */}
      ...
      <div className="relative hidden flex-1 flex-col justify-between overflow-hidden bg-[#55ACEE] p-12 lg:flex">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="leading-none">
            ...
            <span className="block text-3xl font-black tracking-tight text-[#1a1a2e]">
        ...
        <div className="max-w-lg">
          ...
          <p className="mt-5 text-lg leading-relaxed text-white/95">
            ...
            Real-time inventory, scan-first fulfillment, manufacturing, and

            embedded B2B payments — on one system.
      ...
      {/* Sign-in panel — dark charcoal surface */}
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 flex items-center justify-center gap-3 lg:hidden">
            ...
            <div className="leading-tight">
              ...
              <span className="block text-xs font-semibold tracking-widest text-white/70">
          ...
          <p className="mt-6 text-center text-xs text-white/40">
            ...
            Demo: demo-corp · owner@demo.test · password123
