 ...
 * {@code action_chip} = NAVIGATE / SPOTLIGHT / START_TOUR instructor chips.
 */
public record SupportActionProposal(
    ...
    public static SupportActionProposal startTour(String label, String tourId) {
        return chip("START_TOUR", label, tourId);
    }
